...
CREATE TABLE `division_table` (
  ...
  `assignedno_of_workers` int DEFAULT NULL,
  `no_of_handcarts` int DEFAULT NULL,
...
CREATE TABLE `employee_table` (
  ...
  UNIQUE KEY `salary id_UNIQUE` (`salary_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vehicle_detail` VALUES (1,'RD-8394'),(2,'RD-8399'),(3,'49-9423'),(4,'ZB-365'),(5,'RE-9396'),(6,'RQ-794'),(7,'RD-8392'),(8,'RD-4877'),(9,'48-824'),(10,'RD-8390'),(11,'RD-8318'),(12,'43-2882'),(13,'RD-1610');
/*!40000 ALTER TABLE `vehicle_detail` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vehicle_distribution`
--

DROP TABLE IF EXISTS `vehicle_distribution`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `vehicle_distribution`
--

LOCK TABLES `vehicle_distribution` WRITE;
/*!40000 ALTER TABLE `vehicle_distribution` DISABLE KEYS */;
/*!40000 ALTER TABLE `vehicle_distribution` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `vehicle_repair` (
  ...
  `repair_in` date DEFAULT NULL,
  `repair_out` date DEFAULT NULL,
